...
public class DashboardUI extends UI {
    ...
    private void buildLoginView(boolean exit) {
        ...
        HelpOverlay w = helpManager
                .addOverlay(
                        "Welcome to Ostia Application",
                        "<p>This is a demo app, just sing in</p>",
                        "login");
        w.center();
        addWindow(w);
        ...
        Label title = new Label("Ostia Dashboard");
    ...
    private void buildMainView() {
        ...
        for (final String view : new String[] { "dashboard", "apis",
                "model", "pages", "themes","schedule" }) {
